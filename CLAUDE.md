...
Griffin's loop (2026-09-25): feedback, change, live immediately. After each change: bump `?v=` on
styles.css and app.js in index.html when either changed (returning phones keep old copies), commit,
