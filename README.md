...
Pamphlet design: Safir Bellali ©2026. Capoeira Brasil logo from [capoeirabrasil.com](https://capoeirabrasil.com/).

Static files only (`index.html`, `styles.css`, `app.js`, `assets/`), with no build step; any static host works.
